            ...
            var table = $(".data-table").DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: 'id_kabupaten',
                        render: function(data, type, full, meta) {
                            console.log(full.data_kabupaten)
                            console.log(meta)
                            return full.data_kabupaten.nama;
                        }
                    },
                    {
                        data: 'action',
                ...
                $.get("{{ route('Dependent.index') }}" +
                    ...
                    function(data) {
                        ...
                        $("#id_kabupaten").val(data.id_kabupaten).attr('selected',
                            'selected');
                        var id_kabupaten = data.id_kabupaten;
                                ...
                                success: function(data) {
                                    if (data) {
                                        ...
                                        $.each(data, function(key, kabupatens) {
                                            ...
                                            $('select[name="id_kabupaten"]').append(
                                                `<option value="` + kabupatens
                                                .id + `" ` + ( kabupatens.id == id_kabupaten ? 'selected' : '' ) +`>` +
                                                kabupatens.nama + `</option>`);
                                        });
                                    }
                                }
